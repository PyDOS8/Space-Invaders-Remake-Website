...
function outputWeaponType(){
    var WeaponType = document.getElementById("weapon-type").innerText;
    var Weapon = document.getElementById("player-bullet").src;
    if(this.Weapon == "imgs/weapons/missile.jpg"){
        this.WeaponType = "Missile";
    }
    if(this.Weapon == "imgs/weapons/machineGun.jpg"){
        this.WeaponType = "Machine Gun";
    }
    if(this.Weapon == "imgs/weapons/bullet.jpg"){
        this.WeaponType = "Gun";
    }
}
...
function ShootUp(){
    if(!this.GameOver == true){
        if(this.ammo > 0){
            ...
            this.bullet.top = "100%";
            document.getElementById("weapon-type").src = this.bullet.src;
            this.outputWeaponType();
        }
        var ammoLabel = document.getElementById("AmmoLeftLabel");
        this.ammoLabel.innerText = this.ammo;
...
function showPowerUp(){
    ...
    if(powerup == 0){
        ...
        this.powerupImg = "imgs/powerups/extraHealth.jpg";
    }
    if(powerup == 1){
        var powerUpImg = document.getElementById("powerup").src;
        this.powerUpImg = "imgs/powerups/extraDamage.jpg";
    }
    if(powerup == 2){
        var powerUpImg = document.getElementById("powerup").src;
        this.powerUpImg = "imgs/powerups/machineGun.jpg";
    }
